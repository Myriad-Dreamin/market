...
router_file=router/${object_name}-router.go
...
cp router/object-router.go $router_file
...
sed -i "s/\"object\"/\"${object_name}\"/g" $router_file
sed -i "s/object/${camel_object_name}/g" $router_file
sed -i "s/Object/${up_camel_object_name}/g" $router_file
sed -i "s/oid/${placeholder}/g" $router_file
...
sed -i "s|objectRouter[ ]\*ObjectRouter|objectRouter *ObjectRouter\n\t${camel_object_name}Router *${up_camel_object_name}Router|g" $model_provider_file
